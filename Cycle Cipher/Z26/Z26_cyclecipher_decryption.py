...
#Print file ------------------------------------------------------------------------------------------------------------------------------
    ...
    new_plaintext_in_Z26=[]
    for byte in new_plaintext:
        new_plaintext_in_Z26.append(byte+65)
    
    new_plaintext_in_Z26=bytearray(new_plaintext_in_Z26)

    f=open(decrypted_file,"ab")
    f.write(new_plaintext_in_Z26)
    f.close()
